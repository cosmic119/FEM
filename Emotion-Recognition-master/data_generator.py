...
def augment_brightness_on_image(image_gray):
    cv2.imwrite("brightness_1_gray.png", image_gray)
    image_rgb = cv2.cvtColor(image_gray, cv2.COLOR_GRAY2RGB)
    image_hsv = cv2.cvtColor(image_rgb, cv2.COLOR_RGB2HSV)
    cv2.imwrite("brightness_2_hsv.png", image_hsv)
    ...
    cv2.imwrite("brightness_3_hsv_edited.png", image_hsv)
    image_rgb = cv2.cvtColor(image_hsv, cv2.COLOR_HSV2RGB)
    cv2.imwrite("brightness_4_rgb.png", image_rgb)
    image_gray = cv2.cvtColor(image_rgb, cv2.COLOR_RGB2GRAY)
    cv2.imwrite("brightness_5_gray.png", image_gray)
    return image_gray
